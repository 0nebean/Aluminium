package net.onebean.aluminium.common.thymeleaf.base;
...
public abstract class BaseAbstractElementTagProcessor extends AbstractElementTagProcessor {
    ...
    public BaseAbstractElementTagProcessor(TemplateMode templateMode, String dialectPrefix, String elementName, boolean prefixElementName, String attributeName, boolean prefixAttributeName, int precedence) {
