...
public class LoginSuccessDoOnceFilter implements Filter {

    private static final PathMatcher PATH_MATCHER = new AntPathMatcher(System.getProperty("file.separator"));
    private static final Logger LOGGER = LoggerFactory.getLogger(LoginSuccessDoOnceFilter.class);
    @Override
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
        ...
        for (String unSecuredUrl : AccessWhiteList.unSecuredUrls) {
