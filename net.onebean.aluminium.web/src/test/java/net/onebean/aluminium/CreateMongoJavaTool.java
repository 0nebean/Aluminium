...
public class CreateMongoJavaTool {
	...
	protected void initPath(){
		...
		proPath = proPath+"\\net.onebean.aluminium";
		workspacePath = proPath+"\\";
		modelPath = workspacePath +"net.onebean.aluminium.dao\\src\\main\\java\\net\\onebean\\aluminium\\model\\mongo\\";
		daoPath = workspacePath + "net.onebean.aluminium.dao\\src\\main\\java\\net\\onebean\\aluminium\\dao\\mongo\\";
		servicePath = workspacePath + "net.onebean.aluminium.service\\src\\main\\java\\net\\onebean\\aluminium\\service\\mongo\\";
		serviceImplPath = workspacePath + "net.onebean.aluminium.service\\src\\main\\java\\net\\onebean\\aluminium\\service\\impl\\mongo\\";
	...
	protected void executeModel(){
		try {
			StringBuffer sb = new StringBuffer("package net.onebean.aluminium.model.mongo;\n\nimport net.onebean.core.model.BaseModelMongo;");
	...
	protected void executeDao(){
		try {
			StringBuffer sb = new StringBuffer("package net.onebean.aluminium.dao.mongo;\n\nimport org.springframework.stereotype.Component;"
			+"\nimport net.onebean.aluminium.model.mongo."+modelName()+";"
	...
	protected void executeService(){
		try {
			StringBuffer sb = new StringBuffer(" package net.onebean.aluminium.service.mongo;\n\nimport net.onebean.core.mongo.IBaseMongoBiz;"
			+"\nimport net.onebean.aluminium.model.mongo."+modelName()+";");
	...
	protected void executeServiceImpl(){
		try {
			StringBuffer sb = new StringBuffer("package net.onebean.aluminium.service.impl.mongo;\n\nimport org.springframework.stereotype.Service;"
					+ "\nimport net.onebean.core.mongo.BaseMongoBiz;"
					+ "\nimport net.onebean.aluminium.model.mongo."+modelName()
					+";\nimport net.onebean.aluminium.service.mongo."+modelName()+"Service;"
					+ "\nimport net.onebean.aluminium.dao.mongo."+modelName()+"Dao;");
			sb.append("\n\n@Service");
