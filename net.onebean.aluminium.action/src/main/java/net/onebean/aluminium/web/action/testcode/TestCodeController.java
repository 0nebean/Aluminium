package net.onebean.aluminium.web.action.testcode;
...
import net.onebean.aluminium.model.TestCode;
import net.onebean.aluminium.service.TestCodeService;
...
/**
* @author 0neBean
* @description 测试生成代码 controller
* @date 2019-08-01 09:16:32
*/
@Controller
...
public class TestCodeController extends BaseController<TestCode,TestCodeService> {
    ...
    @PreAuthorize("hasPermission('$everyone','PERM_TESTGUA_PREVIEW')")
    ...
    @PreAuthorize("hasPermission('$everyone','PERM_TESTGUA_ADD')")
    ...
    @PreAuthorize("hasPermission('$everyone','PERM_TESTGUA_VIEW')")
    ...
    @PreAuthorize("hasPermission('$everyone','PERM_TESTGUA_EDIT')")
    ...
    */
    ...
    @ResponseBody
    @PreAuthorize("hasPermission('$everyone','PERM_TESTGUA_DELETE')")
